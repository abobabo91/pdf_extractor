...
with col_pdf:
    ...
    selected_model = st.selectbox(
        ...
        index=0,
        help=r"Árak per 1M token:\n"
         r"- gpt-4.1: $1.25 input / $10 output\n"
         r"- gpt-4o: $2.50 input / $10 output\n"
         r"- gpt-4.1-mini: $0.25 input / $2 output\n"
         r"- gpt-4.1-nano: $0.05 input / $0.40 output"
        )
